...
?>
	...
	<ul id="demo1">
		<li>
			<img src="images/slide11111.jpg" alt="" />
		</li>
		<li>
			<img src="images/slide22222.jpg" alt="" />
		</li>

		<li>
			<img src="images/slide33333.jpg" alt="" />
		</li>
	</ul>
	<!-- //main-slider -->
				...
				<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
					<div id="myTabContent" class="tab-content">
						<div role="tabpanel" class="tab-pane fade in active" id="expeditions" aria-labelledby="expeditions-tab">
							<div class="agile-tp">
								<h2>Penawaran Terbaik Minggu Ini
									<?php
...
?>
	...
	<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Gardi'Lab. Bandung Raya</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@email">gardimuhammad5@gmail.com</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+6281289669942</li>
					</ul>
				</div>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2020 Gardi'Lab. All rights reserved</p>
			</div>
		</div>
