...
<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Gardi Muhammad Company</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@email">gardimuhammad@email</a></li>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2020 Gardi's Lab. All rights reserved</p>
			</div>
		</div>
