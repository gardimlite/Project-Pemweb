...
if (isset($_POST["checkout"])) {
    ...
    if ($q3) {
        echo "<div class='notification success'>
                <h1>Berhasil Check Out Bro&Sist TENGKYU <3</h1>
              </div>";
        echo "<meta http-equiv='refresh' content='1; url=index.php'/>";
    } else {
        echo "<div class='notification error'>
                <h1>Gagal Check Out</h1>
              </div>";
        echo "<meta http-equiv='refresh' content='1; url=index.php'/>";
    }
} else {
...
<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Gardi's Lab. Bandung Raya</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@email">Gardimuhammad5@gmail.com</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+62 8113 2412</li>
					</ul>
				</div>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>Gardi's Lab. All rights reserved</p>
			</div>
		</div>
